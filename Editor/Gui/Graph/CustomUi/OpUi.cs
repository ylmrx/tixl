...
namespace T3.Editor.Gui.Graph.CustomUi;

public delegate OpUi.CustomUiResult DrawChildUiDelegate(Instance instance, ImDrawListPtr drawList, ImRect area, Vector2 scale);
        ...
        = new()
              {
                  ...
                  //{Guid.Parse("") , SelectFloatFromDictUi.DrawChildUi}, // SelectFloatFromDict
